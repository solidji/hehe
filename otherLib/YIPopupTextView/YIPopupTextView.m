...
- (id)initWithPlaceHolder:(NSString*)placeHolder maxCount:(NSUInteger)maxCount buttonStyle:(YIPopupTextViewButtonStyle)buttonStyle tintsDoneButton:(BOOL)tintsDoneButton
{
    ...
    if (self) {
        ...
        _backgroundView = [[UIView alloc] initWithFrame:CGRectMake(0, 80, 320, 80)];//460
        _backgroundView.backgroundColor = [UIColor blackColor];
        _backgroundView.alpha = 0;
        _backgroundView.autoresizingMask = UIViewAutoresizingFlexibleWidth | UIViewAutoresizingFlexibleHeight;
        
        _popupView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, 320, 80)];//240
        ...
        CGFloat buttonRisingRatio = 1;//0.3;
...
//            _closeButton.frame = CGRectMake(buttonX, TEXTVIEW_INSETS.top-buttonRisingRatio*CLOSE_IMAGE_WIDTH, CLOSE_IMAGE_WIDTH, CLOSE_IMAGE_WIDTH);
            ...
            _closeButton = [UIButton buttonWithType:UIButtonTypeCustom];
            CGFloat buttonX = buttonX = TEXTVIEW_INSETS.left-(buttonRisingRatio)*10;
            _closeButton.frame = CGRectMake(buttonX, TEXTVIEW_INSETS.top-buttonRisingRatio*10, 38, 27);
            //_acceptButton.frame = CGRectMake(280, 300, 45, 33);
            [_closeButton setBackgroundImage:[UIImage imageNamed:@"38-27-quxiao.png"] forState:UIControlStateNormal];
            [_closeButton setTitleEdgeInsets:UIEdgeInsetsMake(0, 0, 0, 0)];
            [_closeButton setImageEdgeInsets:UIEdgeInsetsMake(0, 0, 0, 0)];
...
//            _acceptButton.frame = CGRectMake(buttonX, TEXTVIEW_INSETS.top-buttonRisingRatio*CLOSE_IMAGE_WIDTH, CLOSE_IMAGE_WIDTH, CLOSE_IMAGE_WIDTH);
            ...
            _acceptButton = [UIButton buttonWithType:UIButtonTypeCustom];
            CGFloat buttonX = buttonX = _popupView.bounds.size.width-TEXTVIEW_INSETS.right/2-CLOSE_IMAGE_WIDTH;
            _acceptButton.frame = CGRectMake(buttonX, TEXTVIEW_INSETS.top-buttonRisingRatio*10, 38, 27);
            //_acceptButton.frame = CGRectMake(280, 300, 45, 33);
            [_acceptButton setBackgroundImage:[UIImage imageNamed:@"38-27-fabu.png"] forState:UIControlStateNormal];
            [_acceptButton setTitleEdgeInsets:UIEdgeInsetsMake(0, 0, 0, 0)];
            [_acceptButton setImageEdgeInsets:UIEdgeInsetsMake(0, 0, 0, 0)];
            UIViewAutoresizing autoresizing = UIViewAutoresizingFlexibleLeftMargin | UIViewAutoresizingFlexibleBottomMargin;
...
- (void)showInView:(UIView*)view
{
    ...
    _backgroundView.frame = CGRectMake(0, 80, frame.size.width, frame.size.height-80);
...
- (void)didReceiveKeyboardWillShowNotification:(NSNotification*)notification
{
    ...
    CGPoint origin = [self.window convertPoint:CGPointMake(0,0) fromView:_backgroundView];
