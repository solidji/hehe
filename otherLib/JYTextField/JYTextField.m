   ...
   lightBorderColor:(UIColor*)lbColor
{
    ...
    if (self) {
		...
		[[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(endmyEditing:) name:UITextFieldTextDidEndEditingNotification object:self];
...
- (void)endmyEditing:(NSNotification*) notification
{
