...
//    
//    if (IOS_VERSION_GREATER_THAN_OR_EQUAL_TO(@"7.0")) { // iOS7 and later
...
////    else
//    { // iOS 6
//        UIColor *colour = [UIColor colorWithRed:182/255. green:182/255. blue:183/255. alpha:1.0];
//        [colour setFill];
//        [self.placeholder drawInRect:rect withFont:self.font lineBreakMode:NSLineBreakByTruncatingTail alignment:self.textAlignment];
//            //- See more at: http://www.brightec.co.uk/blog/how-change-colour-uitextfields-placeholder-text-ios7-and-still-support-ios6#sthash.dVNjxqAU.dpuf
//    }
//}
