...
- (void)setup{
    ...
    self.nextBarButton = [[UIBarButtonItem alloc] initWithTitle:@"后一项" style:UIBarButtonItemStyleBordered target:self action:@selector(nextButtonIsClicked:)];
...
- (void)textFieldDidBeginEditing:(NSNotification *) notification{
    ...
    if ([self.superview isKindOfClass:[UIScrollView class]] && self.scrollView == nil)
        //if ([self.superview isKindOfClass:[UIView class]] && self.scrollView == nil)
